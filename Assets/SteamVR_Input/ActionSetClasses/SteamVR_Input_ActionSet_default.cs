...
namespace Valve.VR
{
    ...
    public class SteamVR_Input_ActionSet_default : Valve.VR.SteamVR_ActionSet
    {
        ...
        public virtual SteamVR_Action_Boolean ClickTriggerLeft
        {
            get
            {
                return SteamVR_Actions.default_ClickTriggerLeft;
            }
        }
        
        public virtual SteamVR_Action_Boolean ClickTriggerRight
        {
            get
            {
                return SteamVR_Actions.default_ClickTriggerRight;
            }
        }
